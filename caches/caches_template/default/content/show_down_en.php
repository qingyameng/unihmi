            ...
            <div class="maincontent clearfix">
                <table width="719" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td class="td2">File size：<?php echo $filesize;?></td>
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td class="td2">Date：<?php if($updatetime) { ?><?php echo $updatetime;?><?php } else { ?><?php echo $inputtime;?><?php } ?></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td class="td2">Amount of Downloads：<span id="hits"></span></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td class="td2">Operating system：<?php echo $systems;?></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td colspan="2"><table width="0" cellspacing="0" cellpadding="0" border="0">
                              <tbody><tr>
                                <td class="td2" width="66" valign="top">description：</td>
