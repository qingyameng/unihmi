...
<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
    <div class="albumblock"><div class="inner"><a href="<?php echo $r['url'];?>" title="<?php echo $r['catname'];?>"><img src="<?php echo $r['image'];?>" onerror="javascript:this.src='<?php echo IMG_PATH;?>home/201667113653.jpg';"></a></div><div class="title"><a href="<?php echo $r['url'];?>"><?php echo $r['catname'];?></a></div><div class="content"><?php echo $r['description'];?></div></div><div class="kong"><div style="border-bottom: 1px dotted #999999; height:25px;"></div></div>
<?php $n++;}unset($n); ?>
